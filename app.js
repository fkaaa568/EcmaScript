...
function BioData (name,age,email,phone){
    this.name = name
    this.age = age
    this.email = email
    this.phone = phone
  ...
  let getData1 = new BioData("Faizan",20,"fkaaa567@gmail.com","03121254699");
  let getData2 = new BioData("Farhan",17,"farhan@gmail.com","031323664699");
